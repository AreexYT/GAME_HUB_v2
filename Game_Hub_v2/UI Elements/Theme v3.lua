...
function UILibrary.Load(GUITitle)
	...
	ContainerFrame.Position = UDim2.new(0.5,0,0.095,-150)
	...
	TitleBar.ImageColor3 = Color3.fromRGB(140,0,140)
	...
	function TabLibrary.AddPage(PageTitle, SearchBarIncluded)
		...
		PageContainer.ImageColor3 = (TabCount == 0) and Color3.fromRGB(50,0,50) or Color3.fromRGB(40,40,40)
			...
			spawn(function()
				for _, Button in next, MenuBar:GetChildren() do
					if Button:IsA("GuiObject") then
						...
						Tween(Button, {ImageColor3 = IsButton and Color3.fromRGB(140,0,140) or Color3.fromRGB(40,40,40)})
